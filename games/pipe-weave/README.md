...
![給水口と回転前の管の配置](../../docs/games/screenshots/pipe-weave/gameplay-1.png)

給水口と回転前の管の配置。

![上半分へ水を通した配管](../../docs/games/screenshots/pipe-weave/gameplay-2.png)

上半分へ水を通した配管。

![残りの未通水部分と漏れを修正する終盤](../../docs/games/screenshots/pipe-weave/gameplay-3.png)
