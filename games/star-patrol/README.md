...
![防壁の隙間から編隊を狙う](../../docs/games/screenshots/star-patrol/gameplay-1.png)

防壁の隙間から編隊を狙う。

![装甲を持つ敵と敵弾をかわす](../../docs/games/screenshots/star-patrol/gameplay-2.png)

装甲を持つ敵と敵弾をかわす。

![残った敵を追い込む終盤](../../docs/games/screenshots/star-patrol/gameplay-3.png)

残った敵を追い込む終盤。

## プレイ動画

[プレイ動画を見る（30秒・音声あり）](https://zabaglione.github.io/jr800-web-emulator/videos/#star-patrol)
