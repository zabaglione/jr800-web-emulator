...
star_score_check:
    TST star_hud_force
    BNE star_score_value
    LDD star_score
    SUBD star_old_score
    BEQ star_running_check
star_score_value:
    LDD star_score
    STD star_old_score
    LDAA #138
...
star_running_check:
    TST star_hud_force
    BNE star_running_value
    LDAA star_running
    CMPA star_old_running
    BEQ star_render_done
star_running_value:
    LDAA star_running
    STAA star_old_running
    LDX #star_shoot_label
    TSTA
    BNE star_running_text
    LDX #star_start_label
star_running_text:
    LDAA #72
    CLRB
    JMP paint_text
