...
![大きな数字タイルと空きマス](../../docs/games/screenshots/slide-nine/gameplay-1.png)

大きな数字タイルと空きマス。

![第9面の並べ替え途中](../../docs/games/screenshots/slide-nine/gameplay-2.png)

第9面の並べ替え途中。

![第19面の終盤パズル](../../docs/games/screenshots/slide-nine/gameplay-3.png)
