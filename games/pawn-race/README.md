...
![白と黒の12個ずつの駒で対局開始](../../docs/games/screenshots/pawn-race/gameplay-1.png)

白と黒の12個ずつの駒で対局開始。

![選択した駒の移動先を確認](../../docs/games/screenshots/pawn-race/gameplay-2.png)

選択した駒の移動先を確認。

![突破を狙う駒と後方の守り](../../docs/games/screenshots/pawn-race/gameplay-3.png)

突破を狙う駒と後方の守り。

## プレイ動画

[プレイ動画を見る（30秒・音声あり）](https://zabaglione.github.io/jr800-web-emulator/videos/#pawn-race)
