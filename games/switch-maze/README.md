...
![2系統のスイッチと鍵がある最初の迷路](../../docs/games/screenshots/switch-maze/gameplay-1.png)

2系統のスイッチと鍵がある最初の迷路。

![第8面で扉の開閉順序を考える場面](../../docs/games/screenshots/switch-maze/gameplay-2.png)

第8面で扉の開閉順序を考える場面。

![第17面の鍵回収と帰り道](../../docs/games/screenshots/switch-maze/gameplay-3.png)
