...
; switch-maze: circuit, play origin 0
.equ VIEW_X,0
.equ HUD_FIELDS,5
.section .text, code
visual_hud:
...
hud_pixels_1:
    .byte $FF,$FF,$DB,$D5,$ED,$FF,$C1,$E7,$C1,$FF,$DD,$C1,$DD,$FF,$FD,$C1,$FD,$FF,$E3,$DD,$DD,$FF,$C1,$F7
    .byte $C1,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF
    .byte $FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF
