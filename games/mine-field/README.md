...
![タイトル画面](../../docs/games/screenshots/mine-field/title.png)
...
RETURNのFLAG MODEに入ると、SPACEで旗を置く・取り除く操作になります。旗は地雷の数まで置けます。RETURNで旗モードを終了し、OPENに戻ります。旗を置いたマスは開きません。上部のFが旗の数、Mが地雷の数、LEFTが残りの安全な未開放マス数です。
...
![最初の安全な場所から空白領域を開放](../../docs/games/screenshots/mine-field/gameplay-1.png)

最初の安全な場所から空白領域を開放。

![旗を置いて地雷の位置を整理](../../docs/games/screenshots/mine-field/gameplay-2.png)

旗を置いて地雷の位置を整理。

![旗の推理違いで地雷が開いた失敗画面](../../docs/games/screenshots/mine-field/gameplay-3.png)
