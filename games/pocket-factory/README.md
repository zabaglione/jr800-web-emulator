...
![タイトル画面](../../docs/games/titles/pocket-factory.png)
...
![第1面の初期配置と規定手数](../../docs/games/screenshots/pocket-factory/gameplay-1.png)

第1面の初期配置と規定手数。

![第31面で追加目標に挑戦している場面](../../docs/games/screenshots/pocket-factory/gameplay-2.png)

第31面で追加目標に挑戦している場面。

![第40面を規定手数と追加目標の両方を満たしてクリア](../../docs/games/screenshots/pocket-factory/gameplay-3.png)

第40面を規定手数と追加目標の両方を満たしてクリア。

![メイン画面で選択できる工具](../../docs/games/screenshots/pocket-factory/motion.png)
...
![面選択とパスワード](../../docs/games/screenshots/pocket-factory/selection.png)
