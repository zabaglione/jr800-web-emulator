...
カードのCOSTが残りエナジー以下なら使用できます。使ったカードは捨て札へ移り、ターン終了時に残りの手札も捨てて3枚引き直します。山札が尽きると捨て札をシャッフルします。敵のNEXT表示は次の行動です。8回の勝利報酬では3枚から1枚を選んでデッキへ追加し、HPを12回復します（上限40）。難易度1〜3を選べます。
