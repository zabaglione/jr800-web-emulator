...
横線が入ったブロックは2回当てると壊れます。接触ごとに10点が入り、SCOREに表示されます。LEFTは残りのブロック数です。LIFEは残りのボール数で、各面3個から始まります。落とした後は再びSPACEで発射してください。3個とも失うと失敗します。
...
![最初の配置と発射位置](../../docs/games/screenshots/wall-break/gameplay-1.png)

最初の配置と発射位置。

![複数回当てるブロックを含む盤面](../../docs/games/screenshots/wall-break/gameplay-2.png)

複数回当てるブロックを含む盤面。

![最後に残ったブロックを狙う](../../docs/games/screenshots/wall-break/gameplay-3.png)
