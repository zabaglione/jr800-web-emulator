...
wall_draw_paddle:
    ...
    LDAB #5
    JSR paint_text
    LDX #wall_return_label
    LDAA #138
    LDAB #7
    JSR paint_text
wall_hud_values:
    TST wall_hud_force
    BNE wall_score_value
    LDD wall_score
    SUBD wall_old_score
    BEQ wall_left_check
wall_score_value:
...
wall_start_check:
    TST wall_hud_force
    BNE wall_start_value
    LDAA wall_active
    CMPA wall_old_active
    BEQ wall_render_done
wall_start_value:
    LDAA wall_active
    STAA wall_old_active
    LDX #wall_blank_label
    TSTA
    BNE wall_start_text
    LDX #wall_start_label
wall_start_text:
    LDAA #78
    CLRB
    JMP paint_text
