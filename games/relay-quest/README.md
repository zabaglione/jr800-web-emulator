...
![タイトル画面](../../docs/games/screenshots/relay-quest/title.png)
...
![扉と資源の位置を読み、遺跡の順路を考える](../../docs/games/screenshots/relay-quest/gameplay-1.png)

扉と資源の位置を読み、遺跡の順路を考える。

![守衛へ向かって攻撃し、通路を確保する](../../docs/games/screenshots/relay-quest/gameplay-2.png)

守衛へ向かって攻撃し、通路を確保する。

![2基を回収し、残り体力を保って出口へ向かう](../../docs/games/screenshots/relay-quest/gameplay-3.png)
