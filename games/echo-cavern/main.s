...
game_render:
    ...
    LDAB #3
    JSR paint_text
    LDX #echo_mapped_label
    LDAA #138
    LDAB #5
    JSR paint_text
    LDX #echo_space_label
    LDAA #138
    LDAB #7
    JSR paint_text
echo_values:
...
echo_mapped_check:
    TST echo_hud_force
    BNE echo_mapped_value
    LDAA echo_mapped
    CMPA echo_old_mapped
    BEQ echo_score_check
echo_mapped_value:
    LDAA echo_mapped
    STAA echo_old_mapped
    LDAA #138
    STAA paint_x
    LDAA #6
    STAA paint_band
...
echo_score_check:
    TST echo_hud_force
    BNE echo_score_value
    LDD echo_score
    SUBD echo_old_score
    BEQ echo_render_done
echo_score_value:
    LDD echo_score
    STD echo_old_score
    LDAA #90
