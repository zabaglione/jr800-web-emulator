...
![タイトル画面](../../docs/games/screenshots/tail-trail/title.png)
...
![食べ物と進む方向を見て開始](../../docs/games/screenshots/tail-trail/gameplay-1.png)

食べ物と進む方向を見て開始。

![食べ物を10個集めて長くなった尾](../../docs/games/screenshots/tail-trail/gameplay-2.png)

食べ物を10個集めて長くなった尾。

![高速な難易度で自分の尾を避ける](../../docs/games/screenshots/tail-trail/gameplay-3.png)
