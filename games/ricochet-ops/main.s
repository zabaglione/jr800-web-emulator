...
rico_score_check:
    TST rico_hud_force
    BNE rico_score_value
    LDD rico_score
    SUBD rico_old_score
    BEQ rico_active_check
rico_score_value:
    LDD rico_score
    STD rico_old_score
    LDAA #138
...
rico_active_check:
    TST rico_hud_force
    BNE rico_active_value
    LDAA rico_active
    CMPA rico_old_active
    BEQ rico_render_done
rico_active_value:
    LDAA rico_active
    STAA rico_old_active
    LDX #rico_flight_label
    TSTA
    BNE rico_active_text
    LDX #rico_fire_label
rico_active_text:
    LDAA #78
    CLRB
