...
![1本の光路と鏡](../../docs/games/screenshots/mirror-link/gameplay-1.png)

1本の光路と鏡。

![2回の反射を使う面](../../docs/games/screenshots/mirror-link/gameplay-2.png)

2回の反射を使う面。

![複数の光源を接続する後半の面](../../docs/games/screenshots/mirror-link/gameplay-3.png)
