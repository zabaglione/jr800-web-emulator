...
; hex-front: terminal, play origin 0
.equ VIEW_X,0
.equ HUD_FIELDS,5
.section .text, code
visual_hud:
...
hud_pixels_1:
    .byte $FF,$FF,$C1,$F5,$CB,$FF,$C1,$D5,$DD,$FF,$C1,$DF,$DF,$FF,$C3,$F5,$C3,$FF,$F9,$C7,$F9,$FF,$FF,$FF
    .byte $FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF
    .byte $FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF

hud_pixels_2:
    .byte $00,$BD,$BD,$FF,$FF,$C1,$E3,$C1,$FF,$C1,$D5,$DD,$FF,$C1,$D5,$DD,$FF,$C1,$DD,$E3,$FF,$FF,$FF,$FF
    .byte $FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF
...
hud_pixels_5:
    .byte $00,$7B,$7B,$FF,$FF,$C1,$F5,$CB,$FF,$C1,$D5,$DD,$FF,$C1,$DF,$DF,$FF,$C3,$F5,$C3,$FF,$F9,$C7,$F9
    .byte $FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF
    .byte $FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$00

hud_pixels_6:
    .byte $00,$EF,$EF,$FF,$FF,$FD,$C1,$FD,$FF,$C1,$DF,$C1,$FF,$C1,$F5,$CB,$FF,$C1,$E3,$C1,$FF,$DB,$D5,$ED
    .byte $FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF
    .byte $FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$00
