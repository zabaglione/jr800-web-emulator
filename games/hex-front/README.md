...
![タイトル画面](../../docs/games/titles/hex-front.png)
...
![左右と上下の接続を目指す序盤](../../docs/games/screenshots/hex-front/gameplay-1.png)

左右と上下の接続を目指す序盤。

![リレーで相手拠点を変換する選択画面](../../docs/games/screenshots/hex-front/gameplay-2.png)

リレーで相手拠点を変換する選択画面。

![リレーを使った後の接続経路](../../docs/games/screenshots/hex-front/gameplay-3.png)

リレーを使った後の接続経路。

![盤面の端からメイン画面のRELAYを選択](../../docs/games/screenshots/hex-front/motion.png)

盤面の端からメイン画面のRELAYを選択。

## プレイ動画

[プレイ動画を見る（30秒・音声あり）](https://zabaglione.github.io/jr800-web-emulator/videos/#hex-front)
