...
![最初の位置と跳べるマスの案内](../../docs/games/screenshots/knight-tour/gameplay-1.png)

最初の位置と跳べるマスの案内。

![通った順番を残しながら盤面を巡回](../../docs/games/screenshots/knight-tour/gameplay-2.png)

通った順番を残しながら盤面を巡回。

![残り7マスの終盤で経路を考える](../../docs/games/screenshots/knight-tour/gameplay-3.png)
