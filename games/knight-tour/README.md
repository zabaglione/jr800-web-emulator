...
![第1面の初期配置と規定手数](../../docs/games/screenshots/knight-tour/gameplay-1.png)

第1面の初期配置と規定手数。

![第31面で追加目標に挑戦している場面](../../docs/games/screenshots/knight-tour/gameplay-2.png)

第31面で追加目標に挑戦している場面。

![第40面を規定手数と追加目標の両方を満たしてクリア](../../docs/games/screenshots/knight-tour/gameplay-3.png)
...
![面選択とパスワード](../../docs/games/screenshots/knight-tour/selection.png)
