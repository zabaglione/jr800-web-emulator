...
hud_pixels_2:
    .byte $00,$BD,$BD,$FF,$FF,$C1,$F7,$C1,$FF,$E3,$DD,$E3,$FF,$DB,$D5,$ED,$FF,$FD,$C1,$FD,$FF,$DD,$C1,$DD
    .byte $FF,$C1,$DF,$DF,$FF,$C1,$D5,$DD,$FF,$DB,$D5,$ED,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF
...
hud_pixels_5:
    .byte $00,$7B,$7B,$FF,$FF,$FD,$C1,$FD,$FF,$C1,$DF,$C1,$FF,$C1,$F5,$CB,$FF,$C1,$E3,$C1,$FF,$DB,$D5,$ED
    .byte $FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF
    .byte $FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$00
