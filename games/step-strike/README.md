...
![敵の配置を見て作戦を立てる](../../docs/games/screenshots/step-strike/gameplay-1.png)

敵の配置を見て作戦を立てる。

![遮蔽物を使って接近する](../../docs/games/screenshots/step-strike/gameplay-2.png)

遮蔽物を使って接近する。

![敵と弾道を見ながら次の1手を選ぶ](../../docs/games/screenshots/step-strike/gameplay-3.png)
