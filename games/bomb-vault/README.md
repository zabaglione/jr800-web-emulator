...
[ビルド可能なソース](https://github.com/zabaglione/jr800-web-emulator/tree/main/games/bomb-vault)

![タイトル画面](../../docs/games/screenshots/bomb-vault/title.png)
...
![鍵入りの箱と巡回する敵を確認](../../docs/games/screenshots/bomb-vault/gameplay-1.png)

鍵入りの箱と巡回する敵を確認。

![壁に隠れて爆風を避ける](../../docs/games/screenshots/bomb-vault/gameplay-2.png)

壁に隠れて爆風を避ける。

![鍵を集めて出口へ向かう](../../docs/games/screenshots/bomb-vault/gameplay-3.png)
