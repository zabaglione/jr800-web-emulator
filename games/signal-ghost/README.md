...
[ビルド可能なソース](https://github.com/zabaglione/jr800-web-emulator/tree/main/games/signal-ghost)

![タイトル画面](../../docs/games/screenshots/signal-ghost/title.png)
...
![カメラの向きと監視範囲を読む](../../docs/games/screenshots/signal-ghost/gameplay-1.png)

カメラの向きと監視範囲を読む。

![回転のタイミングを見て端末へ潜入する](../../docs/games/screenshots/signal-ghost/gameplay-2.png)

回転のタイミングを見て端末へ潜入する。

![片方の系統を止め、残る端末と出口へ進む](../../docs/games/screenshots/signal-ghost/gameplay-3.png)
