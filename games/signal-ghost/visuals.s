...
; signal-ghost: terminal, play origin 32
.equ VIEW_X,32
.equ HUD_FIELDS,5
.section .text, code
visual_hud:
...
hud_span_table:
    ...
    .byte 0,0,0
hud_pixels_0:
    .byte $FF,$FF,$DB,$D5,$ED,$FF,$FD,$C1,$FD,$FF,$C1,$D5,$DD,$FF,$C3,$F5,$C3,$FF,$C1,$DF,$DF,$FF,$FD,$C1
    .byte $FD,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF
...
hud_pixels_2:
    .byte $00,$FF,$C1,$DF,$DF,$FF,$DD,$C1,$DD,$FF,$C1,$E3,$C1,$FF,$C1,$F7,$C9,$FF,$DB,$D5,$ED,$FF,$FF,$FF
    .byte $FF,$FF,$FF,$FF,$FF,$FF,$FF,$00

hud_pixels_3:
    .byte $00,$FF,$DB,$D5,$ED,$FF,$FD,$C1,$FD,$FF,$C1,$D5,$DD,$FF,$C1,$F5,$FB,$FF,$DB,$D5,$ED,$FF,$FF,$FF
    .byte $FF,$FF,$FF,$FF,$FF,$FF,$FF,$00
...
hud_pixels_5:
    .byte $00,$FF,$DB,$D5,$ED,$FF,$E3,$DD,$DD,$FF,$E3,$DD,$E3,$FF,$C1,$F5,$CB,$FF,$C1,$D5,$DD,$FF,$FF,$FF
    .byte $FF,$FF,$FF,$FF,$FF,$FF,$FF,$00

hud_pixels_6:
    .byte $00,$FF,$FF,$C1,$F5,$CB,$FF,$C1,$D5,$DD,$FF,$FD,$C1,$FD,$FF,$C1,$DF,$C1,$FF,$C1,$F5,$CB,$FF,$C1
