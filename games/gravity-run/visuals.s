...
hud_span_table:
    ...
    .byte 0,0,0
hud_pixels_0:
    .byte $FF,$FF,$C1,$F5,$FD,$FF,$C1,$DF,$DF,$FF,$DD,$C1,$DD,$FF,$C1,$F5,$FB,$FF,$FF,$FF,$FF,$FF,$FF,$FF
...
hud_pixels_2:
    .byte $00,$BD,$BD,$FF,$FF,$C1,$DD,$E3,$FF,$DD,$C1,$DD,$FF,$DB,$D5,$ED,$FF,$FD,$C1,$FD,$FF,$FF,$FF,$FF
    .byte $FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF
...
hud_pixels_5:
    .byte $00,$7B,$7B,$FF,$FF,$C1,$DF,$DF,$FF,$DD,$C1,$DD,$FF,$E1,$DF,$E1,$FF,$C1,$D5,$DD,$FF,$DB,$D5,$ED
    .byte $FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF
    .byte $FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$00

hud_pixels_6:
    .byte $00,$EF,$EF,$FF,$FF,$DB,$D5,$ED,$FF,$FD,$C1,$FD,$FF,$C3,$F5,$C3,$FF,$C1,$F5,$CB,$FF,$DB,$D5,$ED
    .byte $FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF
    .byte $FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$00
