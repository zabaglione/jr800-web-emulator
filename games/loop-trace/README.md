...
![開始地点と3つのチェックポイントを確認](../../docs/games/screenshots/loop-trace/gameplay-1.png)

開始地点と3つのチェックポイントを確認。

![順番を守りながら経路を伸ばす](../../docs/games/screenshots/loop-trace/gameplay-2.png)

順番を守りながら経路を伸ばす。

![全地点を巡り最後の線を閉じた完成図](../../docs/games/screenshots/loop-trace/gameplay-3.png)
