...
![タイトル画面](../../docs/games/titles/reversi-mini.png)
...
![辺を確保して返す範囲が広がった中盤](../../docs/games/screenshots/reversi-mini/gameplay-2.png)

辺を確保して返す範囲が広がった中盤。

![残りの空きマスと枚数を読み合う終盤](../../docs/games/screenshots/reversi-mini/gameplay-3.png)

残りの空きマスと枚数を読み合う終盤。

![白の着手と反転、CPUの着手位置の点滅、黒への反転の順に進む演出](../../docs/games/screenshots/reversi-mini/turn-animation.gif)

白の着手と反転、CPUの着手位置の点滅、黒への反転の順に進む演出。

## プレイ動画

[プレイ動画を見る（30秒・音声あり）](https://zabaglione.github.io/jr800-web-emulator/videos/#reversi-mini)
