...
既存6本を含めて計52本を収録しています。作品の概要とジャンルは、[ジャンル別ゲーム一覧](../docs/games/README.md)と[開発一覧](../docs/games/roadmap.md)で確認できます。
...
各作品のタイトルを制作し、HUDも左右の計器、荷札、カード卓、帳簿など作品に合わせて配置しています。[画面設計とメモリー配置](../docs/games/visual-design.md)に制作方針をまとめています。

[POLY DEFENDER](poly-defender/README.md)は、陰影付き立体の敵と戦う横スクロールシューティングです。共有の`poly3d`描画ライブラリを使い、標準のゲーム一覧から起動できます。
