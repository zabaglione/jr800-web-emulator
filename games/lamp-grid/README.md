...
![タイトル画面](../../docs/games/titles/lamp-grid.png)
...
![第31面で追加目標に挑戦している場面](../../docs/games/screenshots/lamp-grid/gameplay-2.png)

第31面で追加目標に挑戦している場面。

![第40面を規定手数と追加目標の両方を満たしてクリア](../../docs/games/screenshots/lamp-grid/gameplay-3.png)
...
![面選択とパスワード](../../docs/games/screenshots/lamp-grid/selection.png)
