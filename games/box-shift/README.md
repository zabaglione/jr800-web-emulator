...
![タイトル画面](../../docs/games/titles/box-shift.png)
...
![第1面の初期配置と規定手数](../../docs/games/screenshots/box-shift/gameplay-1.png)

第1面の初期配置と規定手数。

![14×5マスに広がった第31面で追加目標に挑戦している場面](../../docs/games/screenshots/box-shift/gameplay-2.png)

14×5マスに広がった第31面で追加目標に挑戦している場面。

![右側まで使う第40面を規定手数と追加目標の両方を満たしてクリア](../../docs/games/screenshots/box-shift/gameplay-3.png)
...
![面選択とパスワード](../../docs/games/screenshots/box-shift/selection.png)
