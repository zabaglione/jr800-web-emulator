...
| ジャンル | 作品数 | 内容 |
|---|---:|---|
| [パズル・論理](wiki/Genre-Logic.md) | 10 | 盤面を読み、手順や配置を考えるゲーム。 |
| [盤上戦略](wiki/Genre-Board.md) | 8 | 定番の盤上遊戯と、一手ずつ考える対戦。 |
| [カード・ダイス](wiki/Genre-Cards.md) | 5 | 手札、確率、リスクと報酬を使うゲーム。 |
| [アクション](wiki/Genre-Action.md) | 8 | 移動、回避、ジャンプと空間の判断。 |
| [シューティング](wiki/Genre-Shooting.md) | 6 | 射線、照準、弾道を使うゲーム。 |
| [探索・冒険](wiki/Genre-Adventure.md) | 5 | 未知の場所を調べ、資源を管理して進むゲーム。 |
| [経営・シミュレーション](wiki/Genre-Simulation.md) | 4 | 配置や運用を工夫して目標を達成するゲーム。 |
| [スポーツ・タイミング](wiki/Genre-Sports.md) | 5 | 角度、反応、間合いとタイミングを競うゲーム。 |
