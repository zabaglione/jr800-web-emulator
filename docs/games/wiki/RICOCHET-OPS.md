...
![タイトル画面](https://raw.githubusercontent.com/zabaglione/jr800-web-emulator/main/docs/games/titles/ricochet-ops.png)

鏡で弾を反射させて標的を撃つ、全40面の射撃パズルです。後半は最大7標的と13枚の鏡を扱います。

## 遊び方

左右で砲台の列、上下で8方向の照準を選び、SPACEで発射します。すべての標的を壊せばクリアです。追加目標は、最後の標的を壊すまでに弾を2か所の印へ通すことです。1発で複数の標的を通過できます。鏡の閉じた循環は自動で打ち切ります。

照準と列の変更は手数に含めず、発射1回が1手です。弾数は各面の規定手数より4発多く用意しています。RETURNメニューの UNDO SHOT で直前の発射を戻せますが、戻す操作にも1手かかります。

ゲーム開始時は、自分の位置が効果音とともに短く点滅します。

砲台は隣の列まで1ドットずつ滑らかに移動して表示されます。発射・鏡での反射・標的への命中を、それぞれ異なる効果音で知らせます。

## ゲーム画面

![第1面の初期配置と規定手数](https://raw.githubusercontent.com/zabaglione/jr800-web-emulator/13991a5d547d33993eb28301277893b453a79965/docs/games/screenshots/ricochet-ops/gameplay-1.png)

第1面の初期配置と規定手数。

![第31面で追加目標に挑戦している場面](https://raw.githubusercontent.com/zabaglione/jr800-web-emulator/13991a5d547d33993eb28301277893b453a79965/docs/games/screenshots/ricochet-ops/gameplay-2.png)

第31面で追加目標に挑戦している場面。

![第40面を規定手数と追加目標の両方を満たしてクリア](https://raw.githubusercontent.com/zabaglione/jr800-web-emulator/13991a5d547d33993eb28301277893b453a79965/docs/games/screenshots/ricochet-ops/gameplay-3.png)

第40面を規定手数と追加目標の両方を満たしてクリア。

![隣の列へ移動する途中の砲台](https://raw.githubusercontent.com/zabaglione/jr800-web-emulator/13991a5d547d33993eb28301277893b453a79965/docs/games/screenshots/ricochet-ops/motion.png)

隣の列へ移動する途中の砲台。

## プレイ動画

[プレイ動画を見る（30秒・音声あり）](https://zabaglione.github.io/jr800-web-emulator/videos/#ricochet-ops)
...
![面選択とパスワード](https://raw.githubusercontent.com/zabaglione/jr800-web-emulator/13991a5d547d33993eb28301277893b453a79965/docs/games/screenshots/ricochet-ops/selection.png)
