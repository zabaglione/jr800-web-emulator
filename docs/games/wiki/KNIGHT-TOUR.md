...
![タイトル画面](https://raw.githubusercontent.com/zabaglione/jr800-web-emulator/main/docs/games/titles/knight-tour.png)

形の異なる盤面をナイトの動きで巡る、全40面の巡回パズルです。8マスから36マスへ拡大します。

## 遊び方

方向キーで着地点を選び、SPACEで縦2・横1または縦1・横2マスの跳躍を行います。斜線のマスは使えません。利用可能なマスをすべて1回ずつ訪ねるとクリアです。追加目標は、印のあるマスを最後に訪ねることです。

RETURNメニューから直前の跳躍を戻せます。規定手数は、戻らずに全マスを巡る跳躍回数です。

操作対象のマスや項目はゆっくり点滅します。方向キーを押すと選択位置がすぐにはっきり表示されます。

## ゲーム画面

![第1面の初期配置と規定手数](https://raw.githubusercontent.com/zabaglione/jr800-web-emulator/13991a5d547d33993eb28301277893b453a79965/docs/games/screenshots/knight-tour/gameplay-1.png)

第1面の初期配置と規定手数。

![第31面で追加目標に挑戦している場面](https://raw.githubusercontent.com/zabaglione/jr800-web-emulator/13991a5d547d33993eb28301277893b453a79965/docs/games/screenshots/knight-tour/gameplay-2.png)

第31面で追加目標に挑戦している場面。

![第40面を規定手数と追加目標の両方を満たしてクリア](https://raw.githubusercontent.com/zabaglione/jr800-web-emulator/13991a5d547d33993eb28301277893b453a79965/docs/games/screenshots/knight-tour/gameplay-3.png)

第40面を規定手数と追加目標の両方を満たしてクリア。

## プレイ動画

[プレイ動画を見る（30秒・音声あり）](https://zabaglione.github.io/jr800-web-emulator/videos/#knight-tour)
...
![面選択とパスワード](https://raw.githubusercontent.com/zabaglione/jr800-web-emulator/13991a5d547d33993eb28301277893b453a79965/docs/games/screenshots/knight-tour/selection.png)
