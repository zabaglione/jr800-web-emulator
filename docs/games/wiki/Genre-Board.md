...
| [KNIGHT TOUR](https://github.com/zabaglione/jr800-web-emulator/wiki/KNIGHT-TOUR) | 定番 | ナイトのL字移動で6×6の全マスを一度ずつ巡る、6種類の開始位置のパズルです。 |
| [PEG RESCUE](https://github.com/zabaglione/jr800-web-emulator/wiki/PEG-RESCUE) | 定番 | 独自の31穴盤で石を飛び越して取り、最後の1個を残す20面のパズルです。 |
